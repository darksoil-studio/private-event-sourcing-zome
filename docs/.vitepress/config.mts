...
export default withMermaid({
  ...
  base: "/private-event-sourcing-zome",
  title: "Private Event Sourcing Zome",
  description: "Private Event Sourcing zome for holochain apps",
  themeConfig: {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              {
                text: "PrivateEventSourcingStore",
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/darksoil-studio/private-event-sourcing-zome",
      },
    ],
    search: {
      provider: 'local'
